...
// server/config/plans.js ORG_PLANS; leaving a field blank/"Default" here
// means the server falls back to those hardcoded numbers.
const TIER_DEFAULTS = {
  basic: { maxExams: 50, maxStudents: 300, maxTeachers: 5, aiFeatures: true, advancedAI: false, analytics: true, prioritySupport: false, customBranding: false, apiAccess: false, marketplaceAccess: false, templates: true },
  premium: { maxExams: UNLIMITED, maxStudents: UNLIMITED, maxTeachers: 20, aiFeatures: true, advancedAI: true, analytics: true, prioritySupport: true, customBranding: false, apiAccess: false, marketplaceAccess: false, templates: true },
