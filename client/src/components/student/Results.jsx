...
const Results = () => {
  ...
  // getMatchLabel and the per-answer detail renderer now live in
  // components/shared/AnswerDetail.jsx so staff result views render exactly what students see.

  // ─── Helper: colour-coded score badge ─────────────────────────────────────
  // Still used by the per-section summary below, which stayed in this page.
