...
const plannerResourceRoutes = require('./routes/plannerResources');
...
app.use('/api/lesson-plans', blockExpiredUsers, lessonPlanRoutes);
app.use('/api/planner-resources', blockExpiredUsers, plannerResourceRoutes);
...
console.log('- /api/lesson-plans/* (Lesson planner routes)');
console.log('- /api/planner-resources/* (Slides, exercises, schemes of work)');
